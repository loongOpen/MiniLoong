...
#define _INCLUDE_H_
//Board Type
//都选 集成版本主控 MOCO8  网口向右 平 同时imu_att.z 90
#define MCU_BIND1    0 
#define MCU_BIND2    0//集成版本主控 Tinymal-B C Wheel  网口向右 立 GhostV2
#define MCU_BIND3    0//中山8自由度
#define MCU_TINYMAL  0//mini Tinymal  网口朝前 平
#define MCU_TINKER   1//面前网口上


#define MCU_TINYPALE_S1 0//三自由度舵机版本 Tinypale
#define MCU_TINYPALE 0//立口向左  485轮毂电机
#define USE_IMU_O    0

#define SPI_MESS_TYPE_3BLDC_DIV 1
#define DIV_Q_RESET 0//独立电机标定
extern int spi_comm_mess_type;//协议版本
//----leg sensor 
#define RUN_WEBOTS 0
#define RUN_PI     0
