...
//图像控制命令
void Data_EXTCAN_CMD(u8 *data_buf,u8 num)
{ static u8 cnt[4];
	u8 id;
	vs16 rc_value_temp;
	u8 sum = 0,sum_rx=0;
  ...
  { 
		...
		palm_dj.loss_cnt=0;
		spi_rx_cnt_all++;
		palm_dj.power=*(data_buf+4);
		palm_dj.q_exp[0]=(float)((int16_t)(*(data_buf+5)<<8)|*(data_buf+6))/CAN_POS_DIV;
		palm_dj.q_exp[1]=(float)((int16_t)(*(data_buf+7)<<8)|*(data_buf+8))/CAN_POS_DIV;
		palm_dj.q_exp[2]=(float)((int16_t)(*(data_buf+9)<<8)|*(data_buf+10))/CAN_POS_DIV;
		palm_dj.q_exp[3]=(float)((int16_t)(*(data_buf+11)<<8)|*(data_buf+12))/CAN_POS_DIV;
		palm_dj.q_exp[4]=(float)((int16_t)(*(data_buf+13)<<8)|*(data_buf+14))/CAN_POS_DIV;
		palm_dj.q_exp[5]=(float)((int16_t)(*(data_buf+15)<<8)|*(data_buf+16))/CAN_POS_DIV;
		palm_dj.q_exp[6]=(float)((int16_t)(*(data_buf+17)<<8)|*(data_buf+18))/CAN_POS_DIV;
		palm_dj.q_exp[7]=(float)((int16_t)(*(data_buf+19)<<8)|*(data_buf+20))/CAN_POS_DIV;
		palm_dj.q_exp[8]=(float)((int16_t)(*(data_buf+21)<<8)|*(data_buf+22))/CAN_POS_DIV;
		palm_dj.q_exp[9]=(float)((int16_t)(*(data_buf+23)<<8)|*(data_buf+24))/CAN_POS_DIV;
		palm_dj.q_exp[10]=(float)((int16_t)(*(data_buf+25)<<8)|*(data_buf+26))/CAN_POS_DIV;
		palm_dj.q_exp[11]=(float)((int16_t)(*(data_buf+27)<<8)|*(data_buf+28))/CAN_POS_DIV;
		palm_dj.q_exp[12]=(float)((int16_t)(*(data_buf+29)<<8)|*(data_buf+30))/CAN_POS_DIV;
		palm_dj.q_exp[13]=(float)((int16_t)(*(data_buf+31)<<8)|*(data_buf+32))/CAN_POS_DIV;

	}	
   if(*(data_buf+2)==0x02)//cmd2
  { 

		palm_dj.cal_div[0]=*(data_buf+4);
		palm_dj.cal_div[1]=*(data_buf+5);
		palm_dj.cal_div[2]=*(data_buf+6);
		palm_dj.cal_div[3]=*(data_buf+7);
		palm_dj.cal_div[4]=*(data_buf+8);
		palm_dj.cal_div[5]=*(data_buf+9);
		palm_dj.cal_div[6]=*(data_buf+10);
		palm_dj.cal_div[7]=*(data_buf+11);
		palm_dj.cal_div[8]=*(data_buf+12);
		palm_dj.cal_div[9]=*(data_buf+13);
		palm_dj.cal_div[10]=*(data_buf+14);
		palm_dj.cal_div[11]=*(data_buf+15);
		palm_dj.cal_div[12]=*(data_buf+16);
		palm_dj.cal_div[13]=*(data_buf+17);
		
		palm_dj.q_reset[0]=(float)((int16_t)(*(data_buf+18)<<8)|*(data_buf+19))/CAN_POS_DIV;
		palm_dj.q_reset[1]=(float)((int16_t)(*(data_buf+20)<<8)|*(data_buf+21))/CAN_POS_DIV;
		palm_dj.q_reset[2]=(float)((int16_t)(*(data_buf+22)<<8)|*(data_buf+23))/CAN_POS_DIV;
		palm_dj.q_reset[3]=(float)((int16_t)(*(data_buf+24)<<8)|*(data_buf+25))/CAN_POS_DIV;
		palm_dj.q_reset[4]=(float)((int16_t)(*(data_buf+26)<<8)|*(data_buf+27))/CAN_POS_DIV;
		palm_dj.q_reset[5]=(float)((int16_t)(*(data_buf+28)<<8)|*(data_buf+29))/CAN_POS_DIV;
		palm_dj.q_reset[6]=(float)((int16_t)(*(data_buf+30)<<8)|*(data_buf+31))/CAN_POS_DIV;
		palm_dj.q_reset[7]=(float)((int16_t)(*(data_buf+32)<<8)|*(data_buf+33))/CAN_POS_DIV;
		palm_dj.q_reset[8]=(float)((int16_t)(*(data_buf+34)<<8)|*(data_buf+35))/CAN_POS_DIV;
		palm_dj.q_reset[9]=(float)((int16_t)(*(data_buf+36)<<8)|*(data_buf+37))/CAN_POS_DIV;
		palm_dj.q_reset[10]=(float)((int16_t)(*(data_buf+38)<<8)|*(data_buf+39))/CAN_POS_DIV;
		palm_dj.q_reset[11]=(float)((int16_t)(*(data_buf+40)<<8)|*(data_buf+41))/CAN_POS_DIV;
		palm_dj.q_reset[12]=(float)((int16_t)(*(data_buf+42)<<8)|*(data_buf+43))/CAN_POS_DIV;
		palm_dj.q_reset[13]=(float)((int16_t)(*(data_buf+44)<<8)|*(data_buf+45))/CAN_POS_DIV;
	}	
	  if(*(data_buf+2)==0x03)//cmd3
  { 

		palm_dj.kp[0]=(float)((int16_t)(*(data_buf+4)<<8)|*(data_buf+5))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[1]=(float)((int16_t)(*(data_buf+6)<<8)|*(data_buf+7))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[2]=(float)((int16_t)(*(data_buf+8)<<8)|*(data_buf+9))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[3]=(float)((int16_t)(*(data_buf+10)<<8)|*(data_buf+11))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[4]=(float)((int16_t)(*(data_buf+12)<<8)|*(data_buf+13))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[5]=(float)((int16_t)(*(data_buf+14)<<8)|*(data_buf+15))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[6]=(float)((int16_t)(*(data_buf+16)<<8)|*(data_buf+17))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[7]=(float)((int16_t)(*(data_buf+18)<<8)|*(data_buf+19))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[8]=(float)((int16_t)(*(data_buf+20)<<8)|*(data_buf+21))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[9]=(float)((int16_t)(*(data_buf+22)<<8)|*(data_buf+23))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[10]=(float)((int16_t)(*(data_buf+24)<<8)|*(data_buf+25))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[11]=(float)((int16_t)(*(data_buf+26)<<8)|*(data_buf+27))/CAN_GAIN_DIV_P_M;
		palm_dj.kp[12]=(float)((int16_t)(*(data_buf+28)<<8)|*(data_buf+29))/CAN_GAIN_DIV_P_M;
 	  palm_dj.kp[13]=(float)((int16_t)(*(data_buf+30)<<8)|*(data_buf+31))/CAN_GAIN_DIV_P_M;
 
		palm_dj.kd[0]=(float)((int16_t)(*(data_buf+32)<<8)|*(data_buf+33))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[1]=(float)((int16_t)(*(data_buf+34)<<8)|*(data_buf+35))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[2]=(float)((int16_t)(*(data_buf+36)<<8)|*(data_buf+37))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[3]=(float)((int16_t)(*(data_buf+38)<<8)|*(data_buf+39))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[4]=(float)((int16_t)(*(data_buf+40)<<8)|*(data_buf+41))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[5]=(float)((int16_t)(*(data_buf+42)<<8)|*(data_buf+43))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[6]=(float)((int16_t)(*(data_buf+44)<<8)|*(data_buf+45))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[7]=(float)((int16_t)(*(data_buf+46)<<8)|*(data_buf+47))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[8]=(float)((int16_t)(*(data_buf+48)<<8)|*(data_buf+49))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[9]=(float)((int16_t)(*(data_buf+50)<<8)|*(data_buf+51))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[10]=(float)((int16_t)(*(data_buf+52)<<8)|*(data_buf+53))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[11]=(float)((int16_t)(*(data_buf+54)<<8)|*(data_buf+55))/CAN_GAIN_DIV_D_M;
		palm_dj.kd[12]=(float)((int16_t)(*(data_buf+56)<<8)|*(data_buf+57))/CAN_GAIN_DIV_D_M;
 	  palm_dj.kd[13]=(float)((int16_t)(*(data_buf+58)<<8)|*(data_buf+59))/CAN_GAIN_DIV_D_M;
	}	
}
...
{ // OSIntEnter();  
  ...
  //接收中断
	if( USART_GetITStatus(USART3,USART_IT_RXNE) )
	{
		...
		else if(RxState3==3&&com_data<100)
		{
			RxState3 = 4;
		...
		else if(RxState3==5)
		{
			RxState3 = 0;
			RxBuffer3[4+_data_cnt3]=com_data;
			Data_EXTCAN_CMD(RxBuffer3,_data_cnt3+5);
		}
		else
			RxState3 = 0;
...
{ static u8 cnt[4];
  ...
  { 
	  arm_cmd_s.connect=1;
		arm_cmd_s.loss_connect=0;
    arm_cmd_s.pos_now.x = floatFromData(data_buf, &anal_cnt);
    arm_cmd_s.pos_now.y = floatFromData(data_buf, &anal_cnt);
    arm_cmd_s.pos_now.z = floatFromData(data_buf, &anal_cnt);
    arm_cmd_s.att_now[0] = floatFromData(data_buf, &anal_cnt);
    arm_cmd_s.att_now[1] = floatFromData(data_buf, &anal_cnt);
    arm_cmd_s.att_now[2] = floatFromData(data_buf, &anal_cnt);
	}
...
static void Send_Data_Arm(char *dataToSend , char length)
{
	int i;
  for(i=0;i<length;i++)
     UsartSend6(dataToSend[i]);
}
...
{ char i;	char sum = 0;
  ...
  data_to_send[_cnt++]=0xAA;
	...
	arm_cmd_s.dis=sqrt(
	 arm_cmd_s.pos_set.x*arm_cmd_s.pos_set.x
	+arm_cmd_s.pos_set.y*arm_cmd_s.pos_set.y
	+arm_cmd_s.pos_set.z*arm_cmd_s.pos_set.z);
	
	if(arm_cmd_s.dis<300&&arm_cmd_s.dis>170){
		_temp = (vs16)(arm_cmd_s.pos_set.x+cos(test_t)*40);
		data_to_send[_cnt++]=BYTE1(_temp);
		data_to_send[_cnt++]=BYTE0(_temp);
		_temp = (vs16)(arm_cmd_s.pos_set.y);
		data_to_send[_cnt++]=BYTE1(_temp);
		data_to_send[_cnt++]=BYTE0(_temp);
		_temp = (vs16)(arm_cmd_s.pos_set.z+sin(test_t)*40);
		data_to_send[_cnt++]=BYTE1(_temp);
		data_to_send[_cnt++]=BYTE0(_temp);
		pos_set.x=arm_cmd_s.pos_set.x;
		pos_set.y=arm_cmd_s.pos_set.y;
		pos_set.z=arm_cmd_s.pos_set.z;
	}else{
		_temp = (vs16)(pos_set.x);
		data_to_send[_cnt++]=BYTE1(_temp);
		data_to_send[_cnt++]=BYTE0(_temp);
		_temp = (vs16)(pos_set.y);
		data_to_send[_cnt++]=BYTE1(_temp);
		data_to_send[_cnt++]=BYTE0(_temp);
		_temp = (vs16)(pos_set.z);
		data_to_send[_cnt++]=BYTE1(_temp);
		data_to_send[_cnt++]=BYTE0(_temp);
	}
	_temp = (vs16)(arm_cmd_s.att_set[0]);
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);
	_temp = (vs16)(arm_cmd_s.att_set[1]);
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);
	_temp = (vs16)(arm_cmd_s.att_set[2]);
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);
	
	_temp = (vs16)(arm_cmd_s.move_spd);
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);
	_temp = (vs16)(arm_cmd_s.torque);
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);
//	_temp = (vs16)(arm_cmd_s.cap);
//	data_to_send[_cnt++]=BYTE1(_temp);
//	data_to_send[_cnt++]=BYTE0(_temp);
	data_to_send[_cnt++]=arm_cmd_s.cap;
	data_to_send[_cnt++]=arm_cmd_s.power;
	data_to_send[_cnt++]=arm_cmd_s.mode;
	...
	Send_Data_Arm(data_to_send, _cnt);
}
...
int Current;
char test_pow=1;
_UART_SERVO servo_s[12];//0末端航向 1末端俯仰 2末端横滚 3夹持 4头航向 5头俯仰
float servo_test_q[12]={0};
...
void Uart_Send(uint8_t *buf , uint8_t len)
{
	...
	#if defined(USE_SERIAL_SERVO_BOARD)||1
	for(i=0; i<len; i++){
...
void serial_init(void)//0末端航向 1末端俯仰 2末端横滚 3夹持 4头航向 5头俯仰
{
  ...
  servo_s[4].type=STS3046;
	...
	for(i=0;i<12;i++){
			...
			if(servo_s[i].type==SCS00092)
			{
				servo_s[i].AD_Q=MAX_SERVO_Q_AD_SCS00092;
				servo_s[i].MAX_AD_Q=MAX_SERVO_Q_SCS00092;
				servo_s[i].END_S=END_SCS00091;
			...
			if(servo_s[i].type==STS3046)
			{
				servo_s[i].AD_Q=MAX_SERVO_Q_AD_STS3046;
				servo_s[i].MAX_AD_Q=MAX_SERVO_Q_STS3046;
				servo_s[i].END_S=END_STS3046;
				servo_s[i].sms_type=1;
...
void serial_set_q(char id,float q_set)
{
	uint16_t POS_SET=0;
	if(servo_s[id].connect){
		servo_s[id].exp_q = q_set;
		
		servo_s[id].POS_SET=POS_SET=q_set/(servo_s[id].MAX_AD_Q/2)*servo_s[id].AD_Q/2*servo_s[id].q_inv+servo_s[id].POS_OFF+servo_s[id].POS_OFF_SET;
		if(servo_s[id].sms_type)
			RegWritePosEx_sms(id, servo_s[id].POS_SET, 2250, 50);
		else
			RegWritePos(id, servo_s[id].POS_SET, 0, 1500);
	}
}
...
void serial_set_q_dir(char id,float q_set)
{
	...
	if(servo_s[id].connect){
		...
		servo_s[id].POS_SET=POS_SET=q_set/(servo_s[id].MAX_AD_Q/2)*servo_s[id].AD_Q/2*servo_s[id].q_inv+servo_s[id].POS_OFF+servo_s[id].POS_OFF_SET;
		if(servo_s[id].sms_type)
		  WritePosEx_sms(id, servo_s[id].POS_SET, 65534, 254);
		else
			WritePos(id, servo_s[id].POS_SET, 0, 1500);
	}
}
...
void serial_set_q_sync(char id,float q_set)
{
	...
	if(servo_s[id].connect){
		servo_s[id].exp_q = q_set;
		IDs[id]=id;
		Positionsm[id]=Positions[id]=servo_s[id].POS_SET=POS_SET=q_set/(servo_s[id].MAX_AD_Q/2)*servo_s[id].AD_Q/2*servo_s[id].q_inv+servo_s[id].POS_OFF+servo_s[id].POS_OFF_SET;
		Speeds[id]=2250;
		Accs[id]=50;
	}
}
...
{
	if(servo_s[id].connect){
		servo_s[id].POS = ReadPos(id);
		servo_s[id].LOAD = ReadLoad(id);
		if(servo_s[id].POS!=-1&&servo_s[id].LOAD!=-1){
			servo_s[id].q=(servo_s[id].POS -servo_s[id].POS_OFF)*servo_s[id].q_inv*servo_s[id].MAX_AD_Q/servo_s[id].AD_Q;
			servo_s[id].t=servo_s[id].LOAD/1000.*servo_s[id].t_measure_cmd;
		}
	}
}
...
{
	float err=servo_s[id].exp_q-servo_s[id].q;
	int POS_SET=0;
	if(servo_s[id].connect){
		servo_s[id].exp_q = q_set;
		POS_SET=(servo_s[id].q+err*gain_spd)/(servo_s[id].MAX_AD_Q/2)*servo_s[id].AD_Q/2*servo_s[id].q_inv+servo_s[id].POS_OFF+servo_s[id].POS_OFF_SET;
...
void serial_servo(float dt)//0末端航向 1末端俯仰 2末端横滚 3夹持 4头航向 5头俯仰
{
  static char state=0;
	...
	if(test_pow&&palm_dj.power==0){
		...
		if(!test_q){
			servo_s[0].exp_q=palm_dj.q_exp[0];
			servo_s[1].exp_q=palm_dj.q_exp[1];
			servo_s[2].exp_q=palm_dj.q_exp[2];
			servo_s[3].exp_q=palm_dj.q_exp[3];
			servo_s[4].exp_q=palm_dj.q_exp[4];
			servo_s[5].exp_q=palm_dj.q_exp[5];
			servo_s[6].exp_q=palm_dj.q_exp[6];
			servo_s[7].exp_q=palm_dj.q_exp[7];
			servo_s[8].exp_q=palm_dj.q_exp[8];
			servo_s[9].exp_q=palm_dj.q_exp[9];
			servo_s[10].exp_q=palm_dj.q_exp[10];
			servo_s[11].exp_q=palm_dj.q_exp[11];
		}else{
			servo_s[0].exp_q=servo_test_q[0];
			servo_s[1].exp_q=servo_test_q[1];
			servo_s[2].exp_q=servo_test_q[2];
			servo_s[3].exp_q=servo_test_q[3];
			servo_s[4].exp_q=servo_test_q[4];
			servo_s[5].exp_q=servo_test_q[5];
			servo_s[6].exp_q=servo_test_q[6];
			servo_s[7].exp_q=servo_test_q[7];
			servo_s[8].exp_q=servo_test_q[8];
			servo_s[9].exp_q=servo_test_q[9];
			servo_s[10].exp_q=servo_test_q[10];
			servo_s[11].exp_q=servo_test_q[11];
		}

	  palm_dj.cap_touch=servo_s[3].t;
		palm_dj.cap_touch=servo_s[7].t;
		
#if 1//dir
		for(i=0;i<12;i++){
			serial_set_q_dir(i,servo_s[i].exp_q);
			delay_us(dj_delay);
			serial_publish_q();
		}
#endif
#if 0//sync
		for(i=0;i<12;i++){
			serial_set_q_sync(i,servo_s[i].exp_q);
		}
		//SyncWritePos(IDs, 12, Positions, 0, Speeds);
		SyncWritePosEx_sms(IDs, 12, Positionsm, Speeds, Accs);
		serial_publish_q();
#endif
#if 0//reg
		for(i=0;i<12;i++){
			//servo_s[i].exp_q=sind(t)*90;//test
			serial_set_q(i,servo_s[i].exp_q);
			serial_publish_q();
			delay_us(dj_delay);
		}
#endif
...
void send_fb1_extcan(void)//extcan 扩展电机Feedback
{
	char i;	char sum = 0;
  ...
  data_to_send[_cnt++]=0xBA;
	data_to_send[_cnt++]=0xBF;
	data_to_send[_cnt++]=0x01;//功能字
	data_to_send[_cnt++]=0;//数据量
	
  for(i=0;i<14;i++){
	 data_to_send[_cnt++]=leg_motor.connect_motor[i];
  }
...
void send_fb2_extcan(void)//extcan 扩展电机Feedback
{
	char i;	char sum = 0;
	char data_to_send[100];
	char _cnt=0;
  ...
  data_to_send[_cnt++]=0xBA;
	...
	for(i=0;i<7;i++){
		_temp = (vs16)(leg_motor.q_now[i]*CAN_POS_DIV);
		data_to_send[_cnt++]=BYTE1(_temp);
		data_to_send[_cnt++]=BYTE0(_temp);
  }
...
void send_fb3_extcan(void)//extcan 扩展电机Feedback
{
	char i;	char sum = 0;
	char data_to_send[100];
	char _cnt=0;
