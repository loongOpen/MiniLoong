...
class LeggedRobot2Leg(BaseTask):
    ...
    def _create_envs(self):
        ...
        for s in ["L4_Link_ankel", "R4_Link_ankel"]:      
    ...
    def _reward_foot_slip(self):
        ...
        #print("Force=",self.contact_forces[0, self.feet_indices, 2])
        #print(contact[0,:])
    ...
    def _reward_base_height(self):
        ...
        temp = torch.exp(-torch.abs(base_height - self.cfg.rewards.base_height_target) * 20)
    ...
    def _reward_feet_distance(self):
        ...
        d_min = torch.clamp(foot_dist - fd, -0.1, 0.)
        d_max = torch.clamp(foot_dist - max_df, 0, 0.1)
        #return (torch.exp(-torch.abs(d_min) * 100) + torch.exp(-torch.abs(d_max) * 100)) / 2
        #print(foot_dist[0],d_min[0],d_max[0])
    ...
    def _reward_foot_clearance(self):
        ...
        #print("Height=",footpos_in_body_frame[0,:,2],base_height[0],self.cfg.rewards.clearance_height_target)#0.21
