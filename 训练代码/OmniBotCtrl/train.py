...
if GAIT_SEL=='Trot':
    from configs.tinker_constraint_him_trot_xd import TinkerXdConstraintHimRoughCfg, TinkerXdConstraintHimRoughCfgPPO
else:
    from configs.tinker_constraint_him_stand import TinkerConstraintHimRoughCfg, TinkerConstraintHimRoughCfgPPO

from utils.helpers import get_args
from envs import LeggedRobot,LeggedRobot2Leg,LeggedRobot4Leg,LeggedRobotXd
...
if __name__ == '__main__':
    ...
    task_registry.register("TinkerXd",LeggedRobotXd,TinkerXdConstraintHimRoughCfg(),TinkerXdConstraintHimRoughCfgPPO())
